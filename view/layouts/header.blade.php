        ...
        <div class="container-fluid" style="background-color: {{Session::get('company_bgcolor')}}">
            ...
            <div class="d-none d-lg-flex align-items-center mr-3">
                ...
                <a href="{{route('home')}}" class="mr-20">
                    <img alt="Logo" src="{{asset('assets/images/'.$dashboard_logo)}}" class="max-h-35px" />
                </a>
                <!--end::Logo-->
                        ...
                        <div class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1 pulse pulse-white">
                            ...
                            <span class="symbol symbol-35">
								<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white">
                                    <img src='{{asset('images/')}}/{{\Session::get('company_app_logo')}}' height='30px' alt="Company Logo"/>
                                </span>
                                                ...
                                                <div class="symbol symbol-40 symbol-light-primary mr-5">
                                                    <span class="symbol-label">
                                                        <span class="svg-icon svg-icon-lg svg-icon-primary">
                                                            ...
                                                            <img src='{{asset('images/')}}/{{$value->app_logo}}' height='30px' alt="Company Logo"/>
                                                            <!--end::Svg Icon-->
                                                        </span>
                                                    </span>
                                                </div>
                            ...
                            <ul class="menu-nav">
                                ...
                                <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                                    ...
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                        <ul class="menu-subnav">
                                            <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                <a href="{{URL::route('items.index')}}" class="menu-link">
														<span class="svg-icon menu-icon">
															<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
