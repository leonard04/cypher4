            ...
            <form method="post" action="{{URL::route('items.revision_update')}}" id="formsubmit">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <label for="" class="col-form-label">
                            :
                            {{(isset($vendor[$item->supplier])) ? $vendor[$item->supplier] : ""}}
                            @if(isset($vendor[$item->supplier]) && $vendor[$item->supplier] != $vendor[$itemsup->supplier])
                                <i class="fa fa-arrow-right"></i>
                                {{$vendor[$itemsup->supplier]}}
                            @endif
                        </label>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <label for="" class="col-form-label">
                            ...
                            @if($item->price != $itemsup->price)
                                <i class="fa fa-arrow-right"></i>
                                {{number_format($itemsup->price, 2)}}
                            @endif
                        </label>
                    </div>
                </div>
