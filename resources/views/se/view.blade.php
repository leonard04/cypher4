                        ...
                        <tr>
                            ...
                            @for($i=0; $i<3; $i++)
                                <th class="text-center" colspan="2">
                                    Alternative: {{$i + 1}}
                                    <div>
                                        <select name="vendor[{{$i}}]" class="form-control select2" id="">
                                ...
                                @for($i=0; $i<3; $i++)
                                    <td class="text-center">
                                        <div class="radio-inline">
                                            ...
                                            <input type="number" onchange="calc('{{$item->id}}', '{{$i}}')" name="unit_price[{{$item->id}}][{{$i}}]" id="unit_price_{{$item->id}}_{{$i}}" value="{{(!empty(json_decode($item->unit_price)[$i])) ? json_decode($item->unit_price)[$i] : 0}}" class="form-control">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <?php
                                        $sum = 0;
                                        $price = (!empty(json_decode($item->unit_price)[$i])) ? json_decode($item->unit_price)[$i] * $item->qty : 0;
