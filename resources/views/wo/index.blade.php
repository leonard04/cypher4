                    ...
                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <table class="table table-bordered table-hover display font-size-sm" style="margin-top: 13px !important; width: 100%;">
                            ...
                            <tr>
                                ...
                                <th nowrap="nowrap" class="text-center">SE #</th>
                            ...
                            @foreach($po as $key => $po_item)
                                @if($po_item->rejected_by == null & $po_item->approved_by == null)
                                    <tr>
                                        ...
                                        <td align="center">{{$po_item->wo_type}}</td>
                                        <td align="center">
                                            <a href="{{URL::route('po.view', $po_item->id)}}" class="text-hover-danger">{{$po_item->wo_num}}</a>
                                        </td>
                                        <td align="center">{{$po_item->req_date}}</td>
                                        <td align="center">{{$po_item->reference}}</td>
                                        <td align="center">{{$po_item->created_by}}</td>
                                        ...
                                        <td align="center">{{strip_tags($po_item->notes)}}</td>
                                        <td align="center">
                                            @if($po_item->approved_by == null)
                                                <a href="{{URL::route('wo.appr', $po_item->id)}}" class="btn btn-link btn-xs">waiting <i class="fa fa-clock"></i></a>
                                            @else
                                ...
                                <div class="form-group row">
                                    <table class="table table-responsive-xl col-md-12">
                                        ...
                                        <tr class="bg-secondary">
                                            ...
                                            <td align="right">
                                                <input type="number" class="form-control" placeholder="Discount" value="0" min="0" id="discount" name="discount">
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr class="bg-secondary">
                                        ...
                                        <tr class="bg-secondary">
                                            ...
                                            <td align="right">
                                                <input type="number" class="form-control" value="0" min="0" placeholder="Down Payment" id="dp" name="dp">
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr class="bg-secondary">
