                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        @else
                                            ...
                                            <?php
                                            /** @var TYPE_NAME $item */
                                            $percent[$table] += ($item->amount / $total_sum[$table]) * 100;
                                            ?>
                                        @endif
                                    </td>
                                    <td align="center">
                        ...
                        <tfoot class="bg-secondary">
                            <tr>
                                ...
                                <td align="center">
                                    @if($percent[$table] > 0)
                                        @if($table == "cost")
                                            {{number_format($percent[$table] / ($i - 1), 2)}} %
                                        @else
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-4">List Prognosis</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-4">Other Subject</label>
                                    <div class="col-md-8">
