    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="@if(Auth::user()->user_img == null) background-image:url('{{asset('theme/assets/media/users/default.jpg')}}') @else background-image:url('{{asset('theme/assets/media/users')}}/{{Auth::user()->user_img}}') @endif"> </div>
...
{{--                <div class="text-muted mt-1"><span class="navi-text text-muted text-hover-primary">{{Auth::user()->email}}</span></div>--}}
                <div class="text-muted mt-1"><span class="navi-text text-muted text-hover-primary">{{Auth::user()->position}}</span></div>
                <div class="navi mt-2">
