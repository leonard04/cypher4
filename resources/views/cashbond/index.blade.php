        ...
        <div class="card-body">
            ...
            <div class="tab-content mt-5" id="myTabContent">
                <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="home-tab">
                    <h3> <small>Outstanding Cashbond: </small><b>{{number_format($outstanding,2)}} </b></h3><br>
                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <table class="table table-bordered table-hover display font-size-sm" style="margin-top: 13px !important; width: 100%;">
                            ...
                            $no = 1;
                            @endphp
                            @foreach($cashbondlists as $key => $value)
                                @if($value->user == 'open')
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{number_format($cashin[$value->id][0],2)}}<br>
                                            {{number_format($cashout[$value->id][0],2)}}
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @else
                                                @if($value->approved_by == null && $cashin[$value->id][0] > 0)
                                ...
                                @else
                                    @if($value->user == Auth::user()->username)
                                        <tr>
                ...
                <div class="tab-pane fade" id="sales" role="tabpanel" aria-labelledby="profile-tab">
                    <h3> <small>Outstanding Cashbond: </small><b>{{number_format($outstandingBnk,2)}} </b></h3><br>
                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <table class="table table-bordered table-hover display font-size-sm" style="margin-top: 13px !important; width: 100%;">
