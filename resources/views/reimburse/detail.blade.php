    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <h3>Reimburse Detail of: <b>{{$detail->subject}}</b></h3>
            </div>
        </div>
        <div class="card-body">
            <div class="col-md-12">
                            ...
                            <div class="modal fade" id="addCashOut{{$val->id}}" tabindex="-1" role="dialog" aria-labelledby="addEmployee" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="{{route('reimburse.addCashOut')}}" enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right text-block">
                                            @if($detail->m_approve==null)
                                                ...
                                                <a href="{{route('reimburse.deleteDetail',['id' => $value->id,'id_cb' => $value->id_reimburse])}}" class="btn btn-danger btn-xs btn-PRIMARY" title="Delete" onclick="return confirm('Are you sure you want to delete ?')"><i class="fa fa-trash"></i></a>
                                            @endif
                                        </td>
                ...
                <table class="table table-hover display font-size-sm" style="margin-top: 13px !important; width: 100%;" border="0">
                    ...
                    <tr>
                        ...
                        <th class="text-right">
                            <h4 class=" text-blue"><b>{{$detail->currency}}. {{number_format($cashout,2)}}</b></h4>
                        </th>
                    </tr>
                    </thead>
                </table>
        ...
        <div class="card-footer">
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="{{route('reimburse.index')}}" class="btn btn-success btn-lg">
