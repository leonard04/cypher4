                            ...
                            @foreach($reimburselists as $key => $value)
                                @if($value->user == 'open')
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            @php
                                                $balance = intval($cashin[$value->id][0]) - intval($cashout[$value->id][0]);
                                            @endphp
                                            {{$value->currency}}. {{number_format($balance,2)}}
                                        </td>
                                        ...
                                        <td>
                                            <div class="text-block">
                                                <a href="#" target='_blank' class='btn btn-warning btn-xs' title='Print'><i class="fa fa-print"></i></a>
