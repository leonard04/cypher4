    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-body">
                        ...
                        <td>
                            <table style="margin-right: 50px;clear:both">
                                ...
                                <tr>
                                    <td>Date</td>
                                    <td>:</td>
                                    <td>{{date('d F Y', strtotime($reimburse->input_date))}}</td>
                                </tr>
                                <tr>
                                    <td>Subject</td>
                                    <td>:</td>
                                    <td>{{$reimburse->subject}}</td>
                                </tr>
                                <tr>
                                    <td>Currency</td>
                                    <td>:</td>
            ...
            <table class="table table-hover display font-size-sm" style="margin-top: 13px !important; width: 100%;">
                ...
                @foreach($reimburse_detailOut as $key => $value)
                    <tr valign='top'>
                        ...
                        <td class="text-right" style="border-bottom:none; border-top:none">{{$reimburse->currency}}. {{number_format($value->cashout,2)}}</td>
                    </tr>
                    @php
                ...
                @endforeach
                    <tr>
                        ...
                        <td class="text-right" style="border-top:medium"><b>{{$reimburse->currency}}. {{number_format($cashout,2)}}</b></td>
                    </tr>
                    <tr>
                        <td valign="top" style="border-top:none">&nbsp;</td>
                        ...
                        <td valign="top" style="border-top:none" align='center'>&nbsp;</td>
                        <td class="text-right" style="border-top:none" align='center'><b>{{$reimburse->currency}}. {{number_format($sum,2)}}</b></td>
                    </tr>
                </tbody>
            </table>
            <div class="row">
                <div class="col-md-12">
                    <form  method="post" name="appr" id="appr" class="form-horizontal" action="{{route('reimburse.RAppr')}}">
                        @csrf
                        @if($who == 'finance')
                            <table class='table'>
                                <tr>
                        ...
                        @if($who == 'cashin')
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <strong>Proposed Due Date : {{date("d M Y", strtotime($reimburse->man_fin_cashout_date))}} </strong><br>
                                    <label class="checkbox-inline">
                                        Change due date to : <input type="date" class='form-control' id="due_date" name="due_date" value="{{$reimburse->man_fin_cashout_date}}"/>
                                    </label>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-1 control-label"></label>
                            <div class="col-sm-9">
                                <button type='submit' name='Submit' class="btn btn-success" value='Submit' onClick="return confirm('Are you sure to approve?');"><i class="fa fa-check"></i>&nbsp;&nbsp;Submit</button>
                            </div>
                        </div>
                        ...
                        <input type='hidden' name='subject' value='{{$reimburse->subject}}'>
                    </form>
                </div>
            </div>
        </div>
