                    ...
                    <tbody>
                        @foreach($company as $key => $value)
                            ...
                            @if($level[$value->id] == 2)
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td><i class="fa fa-reply fa-rotate-180"></i> <a href="{{URL::route('company.detail', ['id' => base64_encode($value->id)])}}"> {{$value->company_name}}</a></td>
                                    <td>
                                        @if(empty($value->id_parent))
                                            {{"-"}}
                                        @else
                            ...
                            @if($level[$value->id] == 3)
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td><i class="ml-3 fa fa-reply fa-rotate-180"></i><a href="{{URL::route('company.detail', ['id' => base64_encode($value->id)])}}"> {{$value->company_name}}</a></td>
                                    <td>
                                        @if(empty($value->id_parent))
                                            {{"-"}}
                                        @else
