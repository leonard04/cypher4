    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-body">
            ...
            <div class="m-5">
                    ...
                    <table class="table display table-responsive table-bordered">
                        <thead>
                        <tr>
                            ...
                            @for($i=0; $i<3; $i++)
                                <th class="text-center" colspan="2">
                                    Alternative: {{$i + 1}}
                                    <div>
                                        <select name="vendor[{{$i}}]" class="form-control select2" id="" disabled>
                        ...
                        @foreach($items as $key => $item)
                            <tr>
                                ...
                                <td align="center">
                                    {{$item->qty." ".$uom[$item->item_id]}}
                                    <input type="hidden" name="qty[{{$item->id}}]" id="qty_{{$item->id}}" value="{{$item->qty}}">
                                </td>
                                <td align="center">
                                ...
                                @for($i=0; $i<3; $i++)
                                    <td class="text-center">
                                        <div class="radio-inline">
                                            ...
                                            <input type="number" onchange="calc('{{$item->id}}', '{{$i}}')" name="unit_price[{{$item->id}}][{{$i}}]" id="unit_price_{{$item->id}}_{{$i}}" value="{{(!empty(json_decode($item->price)[$i])) ? json_decode($item->price)[$i] : 0}}" class="form-control">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <?php
                                        $sum = 0;
                                        $price = (!empty(json_decode($item->price)[$i])) ? json_decode($item->price)[$i] * $item->qty : 0;
                        ...
                        <tr>
                            ...
                            @for($i=0; $i<3; $i++)
                                ...
                                <td class="text-center">
                                    <input type="number" onchange="sum_calc('{{$i}}')" value="{{(!empty(json_decode($pev->discs)[$i])) ? json_decode($pev->discs)[$i] : 0}}" min="0" name="discount[{{$i}}]" id="discount_{{$i}}" class="form-control">
                                </td>
                            @endfor
                        </tr>
                        ...
                        <tr>
                            ...
                            @for($i=0; $i<3; $i++)
                                ...
                                <td class="text-center">
                                    <input type="text" onchange="sum_calc('{{$i}}')" name="dp[{{$i}}]" value="{{(!empty(json_decode($pev->dps)[$i])) ? json_decode($pev->dps)[$i] : 0}}" id="dp_{{$i}}" class="form-control">
                                </td>
                            @endfor
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            @for($i=0; $i<3; $i++)
                                <td class="text-center" colspan="2">
                                    <textarea name="d_to[{{$i}}]" id="" style="height: 50px" class="form-control">{{(!empty(json_decode($pev->delivers)[$i])) ? json_decode($pev->delivers)[$i] : null}}</textarea>
                                </td>
                            @endfor
                        </tr>
                        <tr>
                            ...
                            @for($i=0; $i<3; $i++)
                                <td class="text-center" colspan="2">
                                    <textarea name="d_time[{{$i}}]" id="" style="height: 50px" class="form-control">{{(!empty(json_decode($pev->deliver_times)[$i])) ? json_decode($pev->deliver_times)[$i] : null}}</textarea>
                                </td>
                            @endfor
                        </tr>
                        <tr>
                            ...
                            @for($i=0; $i<3; $i++)
                                <td class="text-center" colspan="2">
                                    <textarea name="terms[{{$i}}]" id="" style="height: 50px" class="form-control">{{(!empty(json_decode($pev->terms)[$i])) ? json_decode($pev->terms)[$i] : null}}</textarea>
                                </td>
                            @endfor
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            @for($i=0; $i<3; $i++)
                                <td class="text-center" colspan="2">
                                    <textarea name="notes[{{$i}}]" id="" style="height: 50px" class="form-control">{{(!empty(json_decode($pev->pev_notes)[$i])) ? json_decode($pev->pev_notes)[$i] : null}}</textarea>
                                </td>
                            @endfor
                        </tr>
                        <tr>
