            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                ...
                <div class="card-toolbar">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        @if($to->action_time != null)
                            <a target='_blank' href='#' class='btn btn-xs btn-primary pull-right'>
                    ...
                    <div class="col-md-6">
                        <table class="table" border="0" >
                            ...
                            <tr>
                                ...
                                <td >{{($to->to_cekmeal == 1) ? number_format($to->duration):'0'}} day(s).</td>
                                @php
                                    $subcost_meal = intval($to->duration) * intval($to->to_meal);
                                @endphp
                            ...
                            <tr>
                                ...
                                <td >{{($to->to_cekspending == 1) ? number_format($to->duration):'0'}} day(s).</td>
                                @php
                                    $subcost_spending = intval($to->duration) * intval($to->to_spending);
                                @endphp
                            ...
                            <tr>
                                ...
                                <td >{{($to->to_cekovernight == 1) ? number_format($to->duration):'0'}} day(s).</td>
                                @php
                                    $subcost_overnight = intval($to->duration) * intval($to->to_overnight);
                                @endphp
