...
@section('content')
    <form method="post" action="{{route('to.store')}}" >
        @csrf
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Add Travel Order Detail
            ...
            <div class="card-body">
                <div class="form col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="date" name="departs_on" id="departs_on" class="form-control" value="{{date('Y-m-d')}}" onchange="cal()" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label text-right">Returns On</label>
                        <div class="col-md-8">
                            <input type="date" name="returns_on" id="returns_on" class="form-control" onchange="cal()" value="{{date('Y-m-d')}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label text-right">Duration</label>
                        <div class="col-md-8">
                            <input type="text" name="duration" id="duration" readonly class="form-control">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="from_airport" id="from_airport" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="to_airport" id="to_airport" class="form-control" required>
                            <span><small>(*input will be issued when air tickets)</small></span>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <input type="hidden" name="type_of_travel" value="{{$type}}" id="">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="type_travel" id="type_travel" required>
                                ...
                                <option value="odo">On Days Off</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
            ...
            <div class="card-body">
                    ...
                    <div class="col-8 col-form-label">
                        <div class="checkbox-inline">
                            <label class="checkbox checkbox-success">
                                <input type="checkbox" name="to_spending" id="to_spending"/>
                                <span></span>
                                &nbsp;&nbsp;&nbsp; FT
                                @if($type == 'dom')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8 col-form-label">
                        <div class="checkbox-inline">
                            <label class="checkbox checkbox-success">
                                <input type="checkbox" name="to_overnight" id="to_overnight"/>
                                <span></span>
                                &nbsp;&nbsp;&nbsp; FT
                                @if($type == 'dom')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8 col-form-label">
                        <div class="checkbox-inline">
                            <label class="checkbox checkbox-success">
                                <input type="checkbox" name="to_meal" id="to_meal"/>
                                <span></span>
                                &nbsp;&nbsp;&nbsp; FT
                                @if($type == 'dom')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <select class="form-control" name="to_transport" id="to_transport">
                            ...
                            <option value='1'>To Train station</option>
                            <option value='3'>To Bus station</option>
                            <option value='4'>To WH PSI Cileungsi</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-8 col-form-label">
                        <div class="checkbox-inline">
                            <label class="checkbox checkbox-success">
                                <input type="checkbox" name="travel_boat" id="travel_boat"/>
                                <span></span>
                            ...
                            <label class="checkbox checkbox-success">
                                <input type="checkbox" name="taxi" id="travel_boat"/>
                                <span></span>
                            ...
                            <label class="checkbox checkbox-success">
                                <input type="checkbox" name="rent" id="travel_boat"/>
                                <span></span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8 col-form-label">
                        <div class="checkbox-inline">
                            <label class="checkbox checkbox-success">
                                <input type="checkbox" name="airtax" id="airtax"/>
                                <span></span>
