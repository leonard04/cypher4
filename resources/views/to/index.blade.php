                            ...
                            <td class="text-center">
                                ...
                                @else
                                    @if($value->action == 'approve')
                                        <button class="btn btn-circle btn-icon btn-xs btn-success" disabled><i class='fa fa-check-circle'></i></button>&nbsp;&nbsp;{{date("d F Y", strtotime($value->action_time))}}
                                    @else
                                        <button class="btn btn-circle btn-icon btn-xs btn-danger" disabled><i class='fa fa-window-close'></i></button>&nbsp;&nbsp;{{date("d F Y", strtotime($value->action_time))}}
                                    @endif
                                @endif
                            </td>
                            <td class="text-center">
                                ...
                                @elseif(($value->action != null)&&($value->admin != null))
                                    @if($value->action == 'approve')
                                        ...
                                        @if($value->paid_by == null && $value->paid_time == null)
                                            <a href='{{route('to.tsappr',['id'=>$value->id,'code' => 'check'])}}' class='btn-link'>re-check</a>
                                        @endif
                                    @else
                                        N/A
                                    @endif
