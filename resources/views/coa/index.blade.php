...
@section('content')
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addEmployee"><i class="fa fa-plus"></i>Add COA</button>
                </div>
                <!--end::Button-->
            </div>
        </div>
                ...
                <table class="table table-bordered table-hover display font-size-sm" style="margin-top: 13px !important; width: 100%;">
                    ...
                    @foreach($coa as $key => $value)
                        <tr>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Edit C.O.A.</h5>
                                        ...
                                        <form method="post" action="{{route('coa.store')}}" >
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="form col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Parent </label>
                                                            <select class="form-control" name="id_parent" onchange="idParent(this, {{$value->id}})" id="id_parent{{$value->id}}">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="submit" class="btn btn-primary font-weight-bold" id="btnSubmit{{$value->id}}" disabled>
                            ...
                            <td class="text-center"> {{($id_parents[$value->code] != null)? $parents[$id_parents[$value->code]]:""}}</td>
    ...
    <div class="modal fade" id="addEmployee" tabindex="-1" role="dialog" aria-labelledby="addEmployee" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add C.O.A.</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i aria-hidden="true" class="ki ki-close"></i>
                    </button>
                </div>
