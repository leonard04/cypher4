                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" placeholder="Loan Amount" name="loan_amount" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="number" class="form-control" placeholder="Loan Duration" name="loan_duration" required>
                                    </div>
