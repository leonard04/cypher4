...
@section('content')
    <div class="card card-custom gutter-b">
        ...
        <div class="card-body">
            ...
            <div class="m-5">
                <form action="{{URL::route('leasing.update_plan')}}" method="post">
                    @csrf
                    ...
                    <table class="table display">
                        ...
                        @foreach($loan_item as $key => $value)
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <input type="text" {{$read}} id="cicilan[{{$value->id}}]" onchange="calc_1({{$value->id}})" class="form-control {{$bg}} kt_inputmask_6" name="installment[{{$value->id}}]" value="{{$value->cicilan}}">
                                </td>
                                <td>
                                    <input type="text" {{$read}} id="percent[{{$value->id}}]" onchange="calc_3({{$value->id}})" class="form-control {{$bg}} kt_inputmask_6" name="rate[{{$value->id}}]" value="{{$value->bunga_rate}}">
                                </td>
                                <td align="right">
                                    <input type="text" {{$read}} class="form-control {{$bg}} kt_inputmask_6" id="bunga[{{$value->id}}]" name="interest[{{$value->id}}]" readonly value="{{number_format($value->bunga, 2)}}">
                                </td>
                                <td align="right">
