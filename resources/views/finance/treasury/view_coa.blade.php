                            ...
                            <table class="table display table-borderless table-hover table-responsive-xl">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="number" name="de_amount[]" min="0" class="form-control de_amount" value="{{($tre_his->IDR > 0) ? $tre_his->IDR : ""}}">
                                    </td>
                                    <td>
                                        ...
                                        <input type="number" name="cre_amount[]" min="0" class="form-control cre_amount" value="{{($tre_his->IDR < 0) ? $tre_his->IDR * -1 : ""}}">
                                    </td>
                                </tr>
                                @else
                                    <?php
                                    ...
                                    @for($i = 0; $i < $n ; $i++)
                                        <tr>
                                            <td>
                                                <input type="text" name="debit[]" class="form-control debit" value="{{(isset($data_coa['debit'][$i]['code'])) ? $coa[$data_coa['debit'][$i]['code']] : ""}}">
                                                <input type="number" name="de_amount[]" min="0" class="form-control de_amount" value="{{(isset($data_coa['debit'][$i]['amount'])) ? $data_coa['debit'][$i]['amount'] : ""}}">
                                                <input type="hidden" name="id_coa_debit[]" value="{{(isset($data_coa['debit'][$i]['amount'])) ? $data_coa['debit'][$i]['id'] : ""}}">
                                            </td>
                                            <td>
                                                <input type="text" name="credit[]" class="form-control credit" value="{{(isset($data_coa['credit'][$i]['code'])) ? $coa[$data_coa['credit'][$i]['code']] : ""}}">
                                                <input type="number" name="cre_amount[]" min="0" class="form-control cre_amount" value="{{(isset($data_coa['credit'][$i]['amount'])) ? $data_coa['credit'][$i]['amount'] : ""}}">
