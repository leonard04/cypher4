                ...
                <div class="card-body text-white">
                    <table class="text-white">
                        <tr>
                            ...
                            <td>:</td>
                            <td><b>{{$paper['paper_num'][$inv->paper_type][$inv->paper_id]}}</b></td>
                        </tr>
                        <tr>
                            <td>Total Payment</td>
                            <td>:</td>
                    ...
                    <form action="{{URL::route('inv_in.pay')}}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" min="0" id="amount" max="{{$inv->amount}}" class="form-control" placeholder="{{$inv->amount - $paid}}" name="amount" required>
                                </div>
                            </div>
                            <div class="form-group row">
