                        ...
                        @actionStart('inv_in','read')
                            @foreach($inv_in as $key => $value)
                                <tr>
                                    ...
                                    <td align="center">
                                        {{($paper['gr_date'][$value->paper_id] == null) ? "N/A" : date('d F Y', strtotime($paper['gr_date'][$value->paper_id]))}}
                                    </td>
                                    <td align="center">
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if (response.status == 1){
                            ...
                            $("#address").text(vendordata.address[jsondata.supplier_id])
                            ...
                            $("#bank_acct").text(vendordata.bank_acct[jsondata.supplier_id])
