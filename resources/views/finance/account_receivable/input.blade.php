...
@section('content')
    <div class="card card-custom gutter-b">
        ...
        <div class="card-body">
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <form action="{{route('ar.add_input')}}" method="POST" id="form-entry">
                        @csrf
                        <table class="table table-responsive-xl">
                            ...
                            <tr class="tr_clone">
                                <td>
                                    <textarea name="description[]" id="description" class="form-control description" cols="30" rows="10"></textarea>
                                </td>
                                <td align="center">
                                    <input type="number" onkeyup="calc()" name="qty[]" class="form-control qty" style="width: 50%" required>
                                </td>
                                <td align="center">
                                ...
                                <td align="center">
                                    <input type="number" onkeyup="calc()" name="price[]" class="form-control price" style="width: 50%" required>
                                </td>
                                <td align="right">
                                    <label class="amount col-form-label">{{number_format(0, 2)}}</label>
                                </td>
                            </tr>
                            </tbody>
                            <tfoot>
                                ...
                                <tr>
                                    <td colspan="5">
                                        ...
                                        <button type="button" id="btn-submit" class="btn btn-success btn-xs"><i class="fa fa-check"></i> Save</button>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
    ...
    <script>
        ...
        function sum_amount(){
            ...
            for (let i = 0; i < amount.length; i++) {
                sub += parseInt(amount[i].innerHTML)
            }
