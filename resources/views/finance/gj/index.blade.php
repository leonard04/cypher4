                                ...
                                <table class="table table-responsive-xl">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="form-group">
                                                <input type="number" class="form-control amount_debit" name="amount_debit[]" placeholder="Amount">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input type="number" class="form-control amount_credit" name="amount_credit[]" placeholder="Amount">
                                            </div>
                                        </td>
                                ...
                                <table class="table table-responsive-xl">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="form-group">
                                                <input type="number" class="form-control amount_debit-edit" name="amount_debit[]" id="amount_debit_0" placeholder="Amount">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input type="number" class="form-control amount_credit-edit" name="amount_credit[]" id="amount_credit_0" placeholder="Amount">
                                            </div>
                                        </td>
                                        <td align="center" class="justify-content-center">
                                            <div class="form-group mt-7">
