                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="btn-group">
                                    ...
                                    <a href="{{route('business.investor', $business->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-briefcase"></i> Investors</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mx-auto">
                ...
                <div class="col-md-3 mx-auto">
                    <div class="card card-custom gutter-b bg-secondary">
                        ...
                        <div class="card-body">
                            <h3>{{$business->currency}}. {{number_format($rBalance - $rPaid, 2)}}</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table display table-bordered table-hover" data-page-length="100">
                        ...
                        @foreach($details as $key => $item)
                            ...
                            <tr bgcolor="{{$bgcolor}}">
                                ...
                                <td>
                                    @if($item->status == "Paid")
                                        <span class="text-right">{{number_format($item->cicilan + $item->bunga, 2)}}</span>
                                    @else
