        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="Project Name" name="prj_name" value="{{$business->bank}}" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 col-form-label text-right">Partner Name</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="Partner Name" name="partner_name" value="{{$business->description}}" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 col-form-label text-right">Invested Amount</label>
                    <div class="col-md-9">
                        <input type="number" class="form-control" placeholder="Invested Amount" name="amount" value="{{$business->value}}" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="number" class="form-control" placeholder="Return Duration" value="{{$business->period}}" name="duration" required>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="date" class="form-control" name="given_at" value="{{$business->moneydrop}}" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 col-form-label text-right">Return Payment Start Date</label>
                    <div class="col-md-9">
                        <input type="date" class="form-control" name="start_at" value="{{$business->start}}" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="number" class="form-control" placeholder="Penalty" value="{{$business->own_amount}}" name="own_amount" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <textarea name="own_remarks" class="form-control" cols="30" rows="10">{{$business->own_remarks}}</textarea>
