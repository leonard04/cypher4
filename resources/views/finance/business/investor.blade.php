                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{route('business.updateRate')}}" class="row" method="post">
                            ...
                            <div class="col-md-6 row mx-auto">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="profit_rate" value="{{$investor->Percent}}">
                                </div>
                                <div class="col-md-3">
                                    ...
                                    @if(isset($investor->Details))
                                        ...
                                        @foreach($investor->Details as $keyDetail => $valueDetail)
                                            <tr>
                                                ...
                                                <td>{{(isset($valueDetail->exchange))?number_format($valueDetail->exchange, 2):''}}</td>
                            ...
                            <div class="col-md-12">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        $v_b = floor($investor->Amount + ($investor->Amount * $investor->Percent / 100) * $business->period);
                                        ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-dark table-hover display" id="table-print-{{$key}}">
                                                            ...
                                                            $bungaOwn = floor($investor->Amount * $investor->Percent / 100);
                                                            $nCicilan = 0;
                                                            $nProfit = 0;
                                                            $nTotal = 0;
                                                            ?>
                                                            @foreach($details as $keyDetail => $detail)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="right">{{number_format($investor->Percent, 2)}}</td>
                                ...
                                @else
                                    ...
                                    @foreach(json_decode($business->company) as $keyCompany => $valueCompany)
                                        <tr>
                                            ...
                                            <td>{{(isset($valueCompany->exchange))?number_format($valueCompany->exchange, 2):''}}</td>
