                        ...
                        <table class="table table-bordered table-hover display font-size-sm" style="margin-top: 13px !important; width: 100%;">
                            ...
                            @foreach($bpongoing as $key => $value)
                                <tr>
                                    ...
                                    <td class="text-center">{{number_format($value->nilai_jaminan)}}</td>
                                    <td class="text-center">
                                        @if($value->status == 'Created')
                                            <a href='#' class='btn btn-link btn-xs'><i class='fa fa-pencil-alt'></i>&nbsp;&nbsp;Add Item</a>
                                        @elseif($value->status == 'Marketing Done' ||
                                                $value->status == 'Waiting Approval' ||
                                                $value->status == 'Reject' ||
                                                $value->status == 'Waiting For Release' ||
                                    ...
                                    <td class="text-center">
                                        @if($value->status == 'Created')
                                            <a href='#' class='btn btn-link btn-xs'><i class='fa fa-pencil-alt'></i>&nbsp;&nbsp;Add Item</a>
                                        @elseif($value->status == 'Waiting Approval' ||
                                                  $value->status == 'Reject' ||
                                                  $value->status == 'Waiting For Release' ||
                                                  $value->status == 'Retrieved' ||
                                                  $value->status == 'Received' ||
                                    ...
                                    <td class="text-center">
                                        @if($value->status == 'Released')
                                            <form id='form1' class='form-inline' name='form1' method='post' action='{{route('bp.bondR')}}'>
                                                ...
                                                <input type='submit' name='Retrive' id='Retrive' value='Retrive' class='btn btn-default' />
                                            </form>
                                        @elseif($value->status == 'Retrieved' || $value->status == 'Received')
                                            <label class="label label-success" title="Approved"><i class="fa fa-check"></i></label><br>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="Tender Number" name="tender_number">
                                    </div>
                                </div>
                                <div class="form-group row">
