            ...
            <form action="{{URL::route('leave.submit')}}" id="form-submit" method="POST">
                ...
                <div class="col-xl-8">
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <select name="emp_id" id="emp_id" class="form-control" readonly="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            &nbsp;
                            <input type="radio" name="cuticheck" id="meternity" onclick="checkRadio()" value="{{$absen_bobot->absen_alasan_id}}-meternity" required> Maternity Leave
                        </div>
                    </div>
                    <div class="form-group row">
