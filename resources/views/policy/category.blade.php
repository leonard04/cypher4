        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{{route('policy.index')}}" title="Client Category" class="btn btn-secondary"><i class="fa fa-backspace"></i>Policy List</a>
                    &nbsp;&nbsp;
                    ...
                    @foreach($categories as $key => $value)
                        <tr>
                            ...
                            <div class="modal fade" id="edit{{$value->id_category}}" tabindex="-1" role="basic" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="{{route('policy.storeCategory')}}" >
                                            @csrf
                            ...
                            <td class="text-center">
                                <a href="#" title="Delete" class="btn btn-sm btn-danger btn-icon btn-icon-md" onclick="return confirm('Delete category?')"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
